...
export type SelectedWorkerVacationsStateT = {
  ...
  isLoadingRemoveRequest: boolean;
  isLoadingAcceptRequest: boolean;
  isRequestAcceptError: boolean;
  error?: string;
};
...
export enum SelectedWorkerActionTypes {
  ...
  ACCEPT_SELECTED_WORKER_VACATION_REQUEST = "@@selected-worker/ACCEPT_SELECTED_WORKER_VACATION_REQUEST",
  ACCEPT_SELECTED_WORKER_VACATION_REQUEST_SUCCESS = "@@selected-worker/ACCEPT_SELECTED_WORKER_VACATION_REQUEST_SUCCESS",
  ACCEPT_SELECTED_WORKER_VACATION_REQUEST_ERROR = "@@selected-worker/ACCEPT_SELECTED_WORKER_VACATION_REQUEST_ERROR",

  REMOVE_SELECTED_WORKER_VACATION_REQUEST = "@@selected-worker/REMOVE_SELECTED_WORKER_VACATION_REQUEST",
  REMOVE_SELECTED_WORKER_VACATION_REQUEST_SUCCESS = "@@selected-worker/REMOVE_SELECTED_WORKER_VACATION_REQUEST_SUCCESS",
  REMOVE_SELECTED_WORKER_VACATION_REQUEST_ERROR = "@@selected-worker/REMOVE_SELECTED_WORKER_VACATION_REQUEST_ERROR",
  ...
  CREATE_ALL_WORKERS_WORK_SCHEDULE = "@@selected-worker/CREATE_ALL_WORKERS_WORK_SCHEDULE",
  CREATE_ALL_WORKERS_WORK_SCHEDULE_SUCCESS = "@@selected-worker/CREATE_ALL_WORKERS_WORK_SCHEDULE_SUCCESS",
  CREATE_ALL_WORKERS_WORK_SCHEDULE_ERROR = "@@selected-worker/CREATE_ALL_WORKERS_WORK_SCHEDULE_ERROR",
